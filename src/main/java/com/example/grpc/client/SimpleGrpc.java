...
public final class SimpleGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<com.example.grpc.client.HelloRequest,
            com.example.grpc.client.HelloReply> getSayHelloMethod;
    ...
    @io.grpc.stub.annotations.RpcMethod(
            ...
            requestType = com.example.grpc.client.HelloRequest.class,
            responseType = com.example.grpc.client.HelloReply.class,
            methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<com.example.grpc.client.HelloRequest,
            com.example.grpc.client.HelloReply> getSayHelloMethod() {
        io.grpc.MethodDescriptor<com.example.grpc.client.HelloRequest, com.example.grpc.client.HelloReply> getSayHelloMethod;
            ...
            synchronized (SimpleGrpc.class) {
                if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
                    SimpleGrpc.getSayHelloMethod = getSayHelloMethod =
                            io.grpc.MethodDescriptor.<com.example.grpc.client.HelloRequest, com.example.grpc.client.HelloReply>newBuilder()
                                    .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                                    .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
                                    .setSampledToLocalTracing(true)
                                    .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            com.example.grpc.client.HelloRequest.getDefaultInstance()))
                                    .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            com.example.grpc.client.HelloReply.getDefaultInstance()))
    ...
    public static abstract class SimpleImplBase implements io.grpc.BindableService {
         ...
         * </pre>
         */
        public void sayHello(com.example.grpc.client.HelloRequest request,
                             io.grpc.stub.StreamObserver<com.example.grpc.client.HelloReply> responseObserver) {
            ...
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            ...
                            io.grpc.stub.ServerCalls.asyncUnaryCall(
                                    new MethodHandlers<
                                            com.example.grpc.client.HelloRequest,
                                            com.example.grpc.client.HelloReply>(
    ...
    public static final class SimpleBlockingStub extends io.grpc.stub.AbstractBlockingStub<SimpleBlockingStub> {
         ...
         * </pre>
         */
        public com.example.grpc.client.HelloReply sayHello(com.example.grpc.client.HelloRequest request) {
    ...
    public static final class SimpleFutureStub extends io.grpc.stub.AbstractFutureStub<SimpleFutureStub> {
         ...
         * </pre>
         */
        public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.client.HelloReply> sayHello(
                com.example.grpc.client.HelloRequest request) {
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_SAY_HELLO:
                    serviceImpl.sayHello((com.example.grpc.client.HelloRequest) request,
                            (io.grpc.stub.StreamObserver<com.example.grpc.client.HelloReply>) responseObserver);
                    break;
                default:
    ...
    private static abstract class SimpleBaseDescriptorSupplier
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return com.example.grpc.client.HelloWorldProto.getDescriptor();
        }
